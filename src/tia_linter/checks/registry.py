...
CHECK_REGISTRY: dict[str, CheckMeta] = {
    ...
    # --- Siemens Styleguide & Best Practices (Prüfpunkte 24-34) ------------
    ...
    "styleguide.multi_instanzen": CheckMeta(
        ...
        category=STYLEGUIDE,
        description="Prüfpunkt 27: Timer/Zähler/FB-Aufruf verwendet einen Einzel-Instanz-DB statt einer Multi-Instanz.",
    ...
    "styleguide.udt_wiederkehrende_strukturen": CheckMeta(
        ...
        category=STYLEGUIDE,
        description="Prüfpunkt 28: Identische STRUCT-Definition kommt in mehreren DBs vor, ohne als UDT ausgelagert zu sein.",
    ...
    "styleguide.ob1_komplexitaet": CheckMeta(
        ...
        category=STYLEGUIDE,
        description="Prüfpunkt 29: OB1 enthält mehr Netzwerke mit eigener Logik als der konfigurierte Schwellenwert.",
    ...
    "styleguide.know_how_schutz": CheckMeta(
        ...
        category=STYLEGUIDE,
        description="Prüfpunkt 30: Know-how-geschützter Baustein ist nicht als solcher dokumentiert.",
    ...
    "styleguide.tag_tabellen_nur_io": CheckMeta(
        ...
        category=STYLEGUIDE,
        description="Prüfpunkt 31: Tag-Tabelle enthält Tags außerhalb des I-/Q-Adressbereichs.",
    ...
    "styleguide.nicht_optimierte_bausteine": CheckMeta(
        ...
        category=STYLEGUIDE,
        description="Prüfpunkt 32: Baustein ist mit Standard- statt optimiertem Bausteinzugriff projektiert.",
    ...
    "styleguide.bausteine_im_root": CheckMeta(
        ...
        category=STYLEGUIDE,
        description="Prüfpunkt 33: Mehr Bausteine im Wurzelordner als der konfigurierte Schwellenwert.",
    ...
    "styleguide.schreibschutz": CheckMeta(
        ...
        category=STYLEGUIDE,
        description="Prüfpunkt 34 (neu in V21): Baustein hat Schreibschutz, der nicht dokumentiert ist.",
